$(document).ready(function() {
    ...
    // Form submission (Only applicable to index.html)
    ...
    function showUserPopup(userData) {
        ...
        for (const key in userData) {
            if (userData.hasOwnProperty(key) && key !== '_id' && key !== '__v' && key !== 'socketId') {
                if (key == 'address') {
    ...
    socket.on('connect', () => {
        ...
        if (storedUserData && window.location.pathname === '/live_users.html') {
    ...
    //    // ... (Code for fetching and displaying users in table format remains the same) ...
    // };
    function showUserPopup(userData) {
    ...
    if (window.location.pathname === '/live_users.html') {
